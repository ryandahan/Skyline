<div class="sofa">
    ...
    <div class="form-group row">
        <div class="col-md-5 m-auto">
            <label for="corners">Color of wood</label>


            @if(''===' required="true"') <span class="text-danger font-bolder">*</span> @endif

            <input type="text" name="woodColor" id="woodColor" class="form-control">

            {!! $errors->first('woodColor', '<p class="form-text text-danger">:message</p>') !!}

            <div class="row mt-3 justify-content-center">
                <div class="col-md-6 col-sm-11 mt-3">
                    <img src="{{asset('image/woodColor1.jpeg')}}" alt="no" class="rounded image-style image_size_from" >
                </div>
                <div class="col-md-6 col-sm-11 mt-3">
                    <img src="{{asset('image/woodColor2.jpeg')}}" alt="yes" class="rounded image-style image_size_from" >
                </div>
                <div class="col-md-6 col-sm-11 mt-3">
                    <img src="{{asset('image/woodColor3.jpeg')}}" alt="yes" class="rounded image-style image_size_from" >
                </div>
            </div>
        </div>

        <div class="col-md-5 m-auto">
            <label for="pillowLook">Color of decoration</label>

            <input type="text" name="designColor" id="designColor" class="form-control" >
            ...
            <div class="row mt-3 justify-content-center">
                <div class="col-md-6 col-sm-11 mt-3">
                    <img src="{{asset('image/decoration1.jpeg')}}" alt="no" class="rounded image-style image_size_from" >
                </div>
                <div class="col-md-6 col-sm-11 mt-3">
                    <img src="{{asset('image/decoration2.jpeg')}}" alt="yes" class="rounded image-style image_size_from" >
                </div>
                <div class="col-md-6 col-sm-11 mt-3">
                    <img src="{{asset('image/decoration3.jpeg')}}" alt="yes" class="rounded image-style image_size_from" >
                </div>
            </div>
        </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-md-5 m-auto">
            <label for="corners">The design of decoration</label>

            @if(''===' required="true"') <span class="text-danger font-bolder">*</span> @endif

            <input type="hidden" name="decoration" id="decoration" class="form-control" value="image/woodColor1.jpeg">

            {!! $errors->first('decoration', '<p class="form-text text-danger">:message</p>') !!}



            <div class="row mt-3 justify-content-center decorationlist">
                <div class="col-md-6 col-sm-11 mt-3">
                    <img src="{{asset('image/woodColor1.jpeg')}}" alt="no" data-value="image/woodColor1.jpeg" class="rounded decoration image-style img-thumbnail image_size_from" >
                </div>
                <div class="col-md-6 col-sm-11 mt-3">
                    <img src="{{asset('image/woodColor2.jpeg')}}" alt="yes" data-value="image/woodColor2.jpeg" class="rounded decoration image-style img-thumbnail image_size_from" >
                </div>
                <div class="col-md-6 col-sm-11 mt-3">
                    <img src="{{asset('image/woodColor3.jpeg')}}" alt="yes" data-value="image/woodColor3.jpeg" class="rounded decoration image-style img-thumbnail image_size_from" >
                </div>
            </div>
        </div>
        ...
        <script>
            $('.decoration').on('click', function() {
                ...
                $('#decoration').val(imageValue);

                $('.decoration').removeClass('clicked');
        ...
        <div class="col-md-5 m-auto">
            ...
            <select required name="backPiece" id="backPiece" class="form-control" >
                <optgroup>
                    ...
                    <option value="wave" {{ old('backPiece') == 'wave' ? 'selected' : '' }}>wave</option>
                    <option value="full buttons with upper design" {{ old('backPiece') == 'Corners' ? 'selected' : '' }}>Full buttons with upper design</option>
        ...
        <div class="col-md-5 m-auto">
            ...
            <div class="row mt-3">
                <div class="col-md-6 col-sm-11 mt-2">
                    <img src="{{asset('image/halfNo.jpeg')}}" alt="no" class="rounded half-img img-thumbnail half-yes" style="height: 140px; width: 100%; object-fit: cover;"
                ...
                <div class="col-md-6 col-sm-11 mt-2">
                    <img src="{{asset('image/halfYes.jpeg')}}" alt="yes" class="rounded half-img img-thumbnail half-no" style="height: 140px; width: 100%; object-fit: cover;"
